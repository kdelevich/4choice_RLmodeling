...
Model=load('RLTwoParam_modelingparameters061321_F__OVX.mat');
...
cohorts_list={'F_Sham','F__OVX'};
progressbar('Cohort Progress','Animal Progress','Simulation Progress')
for sheet = cohorts_list
    Model=load(sprintf('RLTwoParam_modelingparameters061321_%s.mat',char(sheet)));
...
progressbar('Cohort Progress','Animal Progress','Simulation Progress')
for sheet = cohorts_list
    Model=load(sprintf('RLSplitAlphaBetaRev_modelingparameters061321_%s.mat',char(sheet)));
    datasize=size(Model.parameters.Animals);
for j=1:datasize(2)
    progressbar([],[],[])
...
progressbar('Cohort Progress','Animal Progress','Simulation Progress')
for sheet = cohorts_list
    Model=load(sprintf('RLSplitAlphaRev_modelingparameters061321_%s.mat',char(sheet)));
    datasize=size(Model.parameters.Animals);
